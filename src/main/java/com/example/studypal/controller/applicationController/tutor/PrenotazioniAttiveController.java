...
public class PrenotazioniAttiveController extends GestisciPrenotazioniGui {
    //funzione chiamato da Controller grafico corrispondente per ottenere le info per stampare a schermo

    public static List<PrenotazioneBean> PrenotazioniAttive(LoggedInUserBean user) {
        ...
        try {
            ...
            risultatiRicerca = prenotazioneDAO.prenotazioniAttive(email);
